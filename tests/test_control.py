...
class RadRobinControlApproxTest(unittest.TestCase):
    ...
    def test_it(self):
        ...
        eig_freq, eig_val = ef.second_order_robin_eigenfrequencies(param, self.l, n)
...
class RadRobinGenericBacksteppingControllerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # create (not normalized) eigenfunctions
        eig_freq, self.eig_val = ef.second_order_robin_eigenfrequencies(self.param, self.l, self.n)
...
class RadRobinSpatiallyVaryingCoefficientControllerTest(unittest.TestCase):
    ...
    def test_it(self):
        ...
        eig_freq_t, self.eig_val_t = ef.second_order_robin_eigenfrequencies(self.param_t, self.l, self.n)
