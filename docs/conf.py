...
# -*- coding: utf-8 -*-
#
# pyinduct documentation build configuration file, created by
...
autoapi_type = "python"
autoapi_dirs = [os.path.join(os.pardir, "pyinduct")]
...
# the built documents.
from setup import VERSION as version, FULL_VERSION as release
