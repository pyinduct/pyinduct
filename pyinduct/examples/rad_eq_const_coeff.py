...
if __name__ == "__main__" or test_examples:
    ...
    field_variable_t = pi.FieldVariable("eig_funcs_t", weight_label="eig_funcs",
                                        location=l)
    ...
    trajectory = parabolic.RadFeedForward(l,
                                          T,
                                          param_ti,
                                          bound_cond_type,
                                          actuation_type,
    ...
    controller = parabolic.control.get_parabolic_robin_backstepping_controller(
        state=x_i_at_l, approx_state=x_i_at_l,
