...
class ShapeFunction(Function):
    r"""
    Base class for mapping, used in approximations.
    ...
    def cure_interval(self, interval, **kwargs):
        """
        Create a network of shapefunctions from this class on the given
        interval.

        The ``kwargs`` can be used e.g. to specify the order of approximation or
        the amount of functions to use.
...
class LagrangeFirstOrder(ShapeFunction):
    ...
    Note:
        Use :py:meth:`LagrangeFirstOrder.cure_interval` the create a basis with
        this class.
    """
